...
const checkboxVariants = cva(
    ' peer h-3 w-3 grid place-content-center shrink-0 rounded-xs border-[1.5px] border-gray-300 focus-visible:outline-hidden transition disabled:cursor-not-allowed disabled:opacity-40 ',
    {
        variants: {
            variant: {
